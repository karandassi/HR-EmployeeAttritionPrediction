...
```
**Deviance is 0.6956 abd 2LL here is 1014 which is also greater than logistic model which has a 2ll of 962.**
...
```
**We can see that the area under curve clearly is 0.7415 which is way less compared to ROC from logistic model of 0.8363.**  
